        ...
        <div class="col-xl-12">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('prisioner.store') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <input class="form-control" type="number" name="prisioner_number"
                                    value="{{ old('prisioner_number') }}" id="example-text-input">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <input class="form-control" type="text" name="birth_address"
                                    value="{{ old('birth_address') }}" id="example-text-input">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <input class="form-control" type="date" name="birth_days"
                                    value="{{ old('birth_days') }}" id="example-date-input">
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <input class="form-control" type="text" name="nasionality"
                                    value="{{ old('nasionality') }}" id="example-text-input">
                            </div>
                        </div>
                        <div class="form-group row">
