        ...
        <div class="col-xl-12">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('officer.update', $item['id']) }}" method="post"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <input class="form-control" type="number" name="nip"
                                    value="{{ old('nip') ?? $item['nip'] }}" id="example-text-input">
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <input class="form-control" type="text" name="position"
                                    value="{{ old('position') ?? $item['position'] }}" id="example-text-input">
                            </div>
                        </div>
